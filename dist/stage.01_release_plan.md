# stage.01_release_plan — Release Planning

Defines a release as a queue + multi-sprint intent. The release must reference real work items (features/bugs/chores) so sprint planning can stay grounded.
...
### core/library/release/release_planning_directive.md
...
### core/library/release/RELEASE_PLAN.md.tmpl

# Release Plan — {{RELEASE_ID}}

- Release ID: {{RELEASE_ID}}
- Release Type: {{RELEASE_TYPE}}  <!-- minor | major | hardening | other -->
- Created (UTC): {{NOW_UTC}}
- Owner: {{OWNER}}
- Team: {{TEAM}}
...
- Foundation Strategy Ref: {{FOUNDATION_STRATEGY_REF}}
- Work Catalog Ref: {{WORK_CATALOG_REF_OR_NONE}}

## 1) Release goal
{{RELEASE_GOAL_ONE_PARAGRAPH}}

## 2) Definition of done (release)
> Must be machine-checkable wherever possible.

- {{RELEASE_DOD_1}}
- {{RELEASE_DOD_2}}
- {{RELEASE_DOD_3}}

## 3) Selected work items (must reference Work Catalog IDs)
> This section is the release queue. No invented items.

| Work Item ID | Type | Title (from catalog) | Feature Spec / Ref | Notes |
|---|---|---|---|---|
| {{ITEM_1_ID}} | {{ITEM_1_TYPE}} | {{ITEM_1_TITLE}} | {{ITEM_1_REF}} | {{ITEM_1_NOTES}} |
| {{ITEM_2_ID}} | {{ITEM_2_TYPE}} | {{ITEM_2_TITLE}} | {{ITEM_2_REF}} | {{ITEM_2_NOTES}} |
| {{ITEM_3_ID}} | {{ITEM_3_TYPE}} | {{ITEM_3_TITLE}} | {{ITEM_3_REF}} | {{ITEM_3_NOTES}} |

## 4) Sprint slot plan (multi-sprint intent)
> Slots are sequential containers, not tied to calendar weeks.
> Each slot references a subset of the selected work items.

### Slot: {{SLOT_1_ID}}
- Slot goal: {{SLOT_1_GOAL}}
- Focus items (IDs): {{SLOT_1_FOCUS_IDS}}
- Required task types: {{SLOT_1_REQUIRED_TASK_TYPES}}
- Expected deliverables: {{SLOT_1_DELIVERABLES}}

### Slot: {{SLOT_2_ID}}
- Slot goal: {{SLOT_2_GOAL}}
- Focus items (IDs): {{SLOT_2_FOCUS_IDS}}
- Required task types: {{SLOT_2_REQUIRED_TASK_TYPES}}
- Expected deliverables: {{SLOT_2_DELIVERABLES}}

<!-- Add more slots as needed -->

## 5) Release gates (tasks that must exist somewhere in the release)
- {{RELEASE_GATE_1}}
- {{RELEASE_GATE_2}}
- {{RELEASE_GATE_3}}
...
- {{OPEN_QUESTION_2_OR_NONE}}

## 7) Traceability
- Charter constraints referenced: {{CHARTER_CONSTRAINT_IDS_OR_NONE}}
- Foundation gate posture referenced: {{FOUNDATION_GATE_POSTURE_REF_OR_NONE}}

### core/library/release/release.yaml.tmpl

kind: release
version: 0.1.0

id: {{RELEASE_ID}}
type: {{RELEASE_TYPE}}  # minor | major | hardening | other

refs:
  charter: {{CHARTER_REF}}
  project_context: {{PROJECT_CONTEXT_REF_OR_NONE}}
  foundation_strategy: {{FOUNDATION_STRATEGY_REF}}
  work_catalog: {{WORK_CATALOG_REF_OR_NONE}}

goal: {{RELEASE_GOAL_ONE_LINE}}
...
sprint_slots:
  - id: {{SLOT_1_ID}}
    goal: {{SLOT_1_GOAL_ONE_LINE}}
    focus_items: {{SLOT_1_FOCUS_IDS_LIST}}  # e.g. [FEAT-001, BUG-002]
    required_task_types: {{SLOT_1_REQUIRED_TASK_TYPES_LIST}}  # e.g. [planning_gate, research_discovery, execution_slice]
    expected_deliverables:
      - {{SLOT_1_DELIVERABLE_1}}

  - id: {{SLOT_2_ID}}
    goal: {{SLOT_2_GOAL_ONE_LINE}}
    focus_items: {{SLOT_2_FOCUS_IDS_LIST}}
    required_task_types: {{SLOT_2_REQUIRED_TASK_TYPES_LIST}}
    expected_deliverables:
      - {{SLOT_2_DELIVERABLE_1}}

release_gates:
  - {{RELEASE_GATE_1}}
  - {{RELEASE_GATE_2}}

### core/library/work_catalog/WORK_CATALOG.yaml.tmpl

# Work Catalog (machine-readable)
#
# Canonical inventory of work items (features/bugs/chores). Release + Sprint planning MUST reference
# item IDs from this catalog to avoid hallucinated scope.
...
items:
  # ---- Examples (delete/replace) ----
  - id: FEAT-001
    type: feature
    title: "Example feature"
    status: backlog  # backlog | planned | in_progress | done | dropped
    priority: medium # low | medium | high | critical
    refs:
      feature_spec: ""  # optional path/link to a feature spec
      issue: ""         # optional link/id
    notes: ""
...
### artifacts/foundation/FOUNDATION_STRATEGY.md (optional)

(missing)

### artifacts/foundation/QUALITY_GATES_SPEC.md (optional)
...
- artifacts/releases/release-001/RELEASE_PLAN.md
- artifacts/releases/release-001/release.yaml


### Repo Files

- ./releases/release-001/RELEASE_PLAN.md
- ./releases/release-001/release.yaml
