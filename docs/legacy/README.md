# Legacy Docs (Python Harness Reference)

NOTE: This repo keeps a snapshot of legacy generated outputs under `archived/legacy-generated-artifacts/` to reduce clutter at the root. The legacy harness will still (re)generate outputs under `artifacts/` when run.
