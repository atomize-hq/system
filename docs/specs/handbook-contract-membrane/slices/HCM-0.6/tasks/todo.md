...
- [x] Confirm HCM-0.6 authority, dependencies, clean entry state, and docs-only boundary.
- [x] Create the slice-local specification, plan, and task list.
- [x] Dispatch and reconcile the repository-truth inventory research.
- [x] Dispatch and reconcile external primary-source precedent research.
