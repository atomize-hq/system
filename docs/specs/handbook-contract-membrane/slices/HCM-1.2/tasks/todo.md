...
- [ ] Replay final manifest/proof; stage only reviewed implementation state.
- [ ] Run staged diff/secret/GitNexus checks and commit implementation first.
- [ ] Create one completed v1.2 parent handoff bound to that commit/review.
- [ ] Rebuild ledger; run all validator/self-test modes and staged checks.
- [ ] Commit only mechanical closeout separately and stop before HCM-1.3.
