...
use crate::repo_file_access::{
    delete_repo_relative_file, read_bytes_no_follow_path, read_repo_relative_string,
    read_string_no_follow_path, resolve_repo_relative_write_path, sha256_repo_relative_file,
    validate_repo_relative_path, write_repo_relative_bytes, NormalizedRepoRelativePath,
    RepoRelativeFileAccessError, RepoRelativeMutationError, RepoRelativeWritePathError,
};
...
pub(crate) fn build_stage_10_feature_spec_capture_provenance(
    repo_root: &Path,
    compile_result: &crate::pipeline_compile::PipelineCompileResult,
...
fn stage_10_pipeline_compile_payload_sha256(
    compile_result: &crate::pipeline_compile::PipelineCompileResult,
) -> String {
    let payload = crate::pipeline_compile::render_pipeline_compile_payload(compile_result);
