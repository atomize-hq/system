...
pub(crate) fn validate_required_heading_order_result(markdown: &str) -> Result<(), String> {
...
pub(crate) fn normalized_charter_structured_input(
    input: &CharterStructuredInput,
...
pub(crate) fn find_charter_template_scaffold_line(document: &str) -> Option<&str> {
    document
        .lines()
        .find(|line| is_charter_template_scaffold_line(line))
}

pub(crate) fn sanitize_charter_template(template: &str) -> String {
