...
pub(crate) const REQUIRED_ENVIRONMENT_INVENTORY_HEADINGS: [&str; 11] = [
    "## What this is",
    "## How to use",
...
pub(crate) struct EnvironmentInventoryValidationExpectations {
    expected_project_context_ref_line: &'static str,
}

impl EnvironmentInventoryValidationExpectations {
    pub(crate) fn for_optional_project_context(has_project_context: bool) -> Self {
        Self {
    ...
    pub(crate) fn expected_project_context_ref_line(self) -> &'static str {
        self.expected_project_context_ref_line
    }
}

pub(crate) fn validate_environment_inventory_markdown(markdown: &str) -> Result<(), String> {
...
pub(crate) fn validate_required_heading_order_result(
    markdown: &str,
...
pub(crate) fn validate_synthesized_environment_inventory_markdown(
    markdown: &str,
