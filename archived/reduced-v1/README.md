...
This directory preserves the earlier reduced-v1 CLI/compiler documentation set.

It is kept for historical reference only.

## Contents

- `contracts/` — the old reduced-v1 contract stack
- `legacy/` — the preserved legacy harness docs that used to sit at `docs/legacy/`
