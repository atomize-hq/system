...
## Dist
Historically `system/dist/` — the directory containing compiled prompts (generated by the harness).
...
## Artifacts
Historically generated files written under `system/artifacts/...`.
...
- the only shipped baseline canonical path is `.handbook/environment_inventory/ENVIRONMENT_INVENTORY.md`
...
## Multiple pipelines
The handbook can support multiple pipeline definitions (e.g., foundation vs release vs sprint workflows).
